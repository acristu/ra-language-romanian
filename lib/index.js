...
var romanianMessages = {
    ra: {
        ...
        input: {
            file: {
                upload_several: "Trageți aici fișiere pentru a încărca sau clic pentru a selecta unul.",
                upload_single: "Trageți aici un fișier pentru a încărca sau clic pentru a selecta unul.",
            },
            image: {
                upload_several: "Trageți aici imagini pentru a încărca sau clic pentru a selecta una.",
                upload_single: "Trageți aici o imagin pentru a încărca sau clic pentru a selecta una.",
            },
            references: {
        ...
        message: {
            ...
            no: "Nu",
            not_found: "Fie că ați introdus o adresă URL greșită, fie ați urmat un link necorespunzător",
            yes: "Da",
        ...
        navigation: {
            ...
            no_more_results: "Numărul de pagină %{page} este în afara limitelor. Încercați pagina anterioară.The page number %{page} is out of boundaries. Try the previous page.",
            page_out_of_boundaries: "PNumărul de pagină %{page} este în afara limitelor",
...
exports.default = romanianMessages;
